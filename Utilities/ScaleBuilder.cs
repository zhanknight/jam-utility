...
{
    public static List<Scale2> GetScales()
    {
        List<Scale2> scales = new List<Scale2>();
        ...
        scales.AddRange(new List<Scale2> { minor, major, dorian, phrygian, lydian, mixolydian, locrian });
